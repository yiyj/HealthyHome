...
class GuideViewController: UIViewController,UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        for i in 0 ..< numOfPages {
            let imgFile = barHeight == 64 ? "guide_\(i + 1)" : "guide_XR_\(i + 1)"
        ...
        let timeBtn = UIButton.init(frame: CGRect(x: frame.size.width - CGFloat(80), y: CGFloat(statusBarHeight), width: CGFloat(60), height: CGFloat(40)))
